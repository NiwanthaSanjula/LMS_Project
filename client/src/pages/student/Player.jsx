...
const Player = () => {
  ...
  const { enrolledCourses, calculateChaperTime, backendUrl, getToken, userData, fetchUserEnrolledCourses} = useContext(AppContext)
      ...
      <div className='md:mt-10'>
        {
          playerData ? (
            <div>
              <YouTube videoId={playerData.lectureUrl.split('/').pop()} options={{playerVars: {autoplay: 1}}} iframeClassName='w-full aspect-video' />
              ...
              <div className='flex justify-between items-center mt-3'>
                ...
                <button 
                  ...
                  className={`text-blue-600 sm:text-lg ${
          ...
          :
          <img src={courseData ? courseData.courseThumbnail : ""} alt="course"/>
        }
